            ...
            <div class="search-container">
                <form action="student" method="get" class="search-form">
                    ...
                    <c:if test="${not empty keyword}">
                        <a href="student?action=list" class="btn btn-outline-secondary btn-sm">
                            Show All
                        </a>
                    </c:if>
                </form>
                ...
                <c:if test="${not empty keyword}">
                    <div class="search-results-info">
                        Search results for: **${keyword}** (Found ${listStudent.size()} students)
                        <%-- SỬA LỖI: Dùng listStudent thay vì students --%>
                    </div>
                </c:if>
            </div>
